...
.tabs{display:flex;border-bottom:1.5px solid var(--bdr);margin-bottom:16px;overflow-x:auto;gap:2px;position:sticky;top:148px;z-index:39;background:var(--surf);padding-top:6px;}
