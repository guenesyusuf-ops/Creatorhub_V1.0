...
/* SIDEBAR */
.sb{width:210px;background:var(--surf);border-right:1px solid var(--bdr);display:flex;flex-direction:column;position:fixed;top:0;left:0;bottom:0;z-index:100;overflow-y:auto;}
...
.topbar{background:var(--surf);border-bottom:1px solid var(--bdr);height:46px;padding:0 18px;display:flex;align-items:center;gap:8px;position:sticky;top:0;z-index:50;}
...
<div class="portal" id="creator-portal">
  <div class="portal-topbar">
    ...
    <div style="margin-left:auto;display:flex;gap:8px;align-items:center">
      <div style="font-size:11px;color:var(--muted)">Angemeldet als: <strong>Mira Hartley</strong></div>
...
function attachCR(container){
  container.querySelectorAll('[data-open-c]').forEach(el=>el.addEventListener('click',()=>openC(+el.dataset.openC)));
